...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $request->validate([
            ...
            'email'      => 'sometimes|required|email|unique:users,email,' . $user->id, // Bỏ qua email của chính mình
            'phone'      => 'nullable|string|max:15',
            'address'    => 'nullable|string|max:500',
            'updated_at' => 'required|date', // Bắt buộc gửi timestamp để Optimistic Locking
        ]);
